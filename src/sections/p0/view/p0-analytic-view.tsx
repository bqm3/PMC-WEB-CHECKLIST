...
export default function P0_AnalyticsView() {
  ...
  const getAnalytics1 = useCallback(async (): Promise<void> => {
    try {
      setIsLoading(true);
      const response = await axios.get(`${process.env.REACT_APP_HOST_API}/p0/analytics/1`);
  ...
  const getAnalytics7 = useCallback(async (): Promise<void> => {
    try {
      setIsLoading(true);
      const response = await axios.get(`${process.env.REACT_APP_HOST_API}/p0/analytics/7`);
  ...
  const getAnalytics2 = useCallback(async (): Promise<void> => {
    try {
      ...
      const response = await axios.get(`${process.env.REACT_APP_HOST_API}/p0/analytics/2`);
  ...
  const getAnalytics3_1 = useCallback(async (): Promise<void> => {
    try {
      ...
      const response = await axios.get(`${process.env.REACT_APP_HOST_API}/p0/analytics/3`);
  ...
  const getAnalytics3_2 = useCallback(async (): Promise<void> => {
    try {
      ...
      const response = await axios.get(`${process.env.REACT_APP_HOST_API}/p0/analytics/4`);
  ...
  const getAnalytics4 = useCallback(async (): Promise<void> => {
    try {
      ...
      const response = await axios.get(`${process.env.REACT_APP_HOST_API}/p0/analytics/5`);
  ...
  const getAnalytics7Days = useCallback(async (): Promise<void> => {
    try {
      ...
      const response = await axios.get(`${process.env.REACT_APP_HOST_API}/p0/analytics/6`);
