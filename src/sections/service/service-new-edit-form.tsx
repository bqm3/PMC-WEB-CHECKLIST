  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      if (currentProduct?.id !== undefined) {
        axios.put(`https://f313-2402-800-b00a-d641-b8fb-e418-2098-4591.ngrok-free.app/api/services/${currentProduct.id}`, data).then((res) => {
          reset();
          enqueueSnackbar('Update success!');
          router.push(paths.dashboard.service.root);
        });
      } else {
        axios.post(`https://f313-2402-800-b00a-d641-b8fb-e418-2098-4591.ngrok-free.app/api/services`, data).then((res) => {
          reset();
