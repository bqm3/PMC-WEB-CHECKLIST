  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    try {
      if (currentRoom) {
        ...
        const response = await axios.post('https://1fe2-2402-800-b00a-d641-f9dc-b3c0-4a1b-e98f.ngrok-free.app/api/rooms/create', formData, config);
        if (response.status === 200) {
          ...
          if (id) {
            ...
            await axios.post('https://1fe2-2402-800-b00a-d641-f9dc-b3c0-4a1b-e98f.ngrok-free.app/api/room-image/create', formData2, config);
