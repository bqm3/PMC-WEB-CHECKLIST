...
export default function RoomNewEditForm({ currentRoom }: PropRoom) {
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    try {
      if (currentRoom) {
        const res1 = await axios.put(`https://1fe2-2402-800-b00a-d641-f9dc-b3c0-4a1b-e98f.ngrok-free.app/api/rooms/update/${currentRoom.id}`, formData, config);
        const res2 = await axios.put(`https://1fe2-2402-800-b00a-d641-f9dc-b3c0-4a1b-e98f.ngrok-free.app/api/room-image/update/${currentRoom.id}`, formData, config);
        // const res3 = await axios.post(`https://1fe2-2402-800-b00a-d641-f9dc-b3c0-4a1b-e98f.ngrok-free.app/api/room_service/update/${currentRoom?.id}`, data.service);
