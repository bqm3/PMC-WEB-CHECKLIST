...
// api
import { useGetProducts, useGetTypeServices } from 'src/api/product';
// components
...
//
import TypeRoomTableRow from '../type-service-table-row';
...
export default function TypeRoomListView() {
  ...
  const notFound = (!dataFiltered.length && canReset) || typeservicesEmpty;
  ...
  const handleEditRow = useCallback(
    (id: string) => {
      router.push(paths.dashboard.typeService.edit(id));
    },
    [router]
  );
        ...
        <CustomBreadcrumbs
          ...
          action={
            <Button
              ...
              href={paths.dashboard.typeService.new}
              variant="contained"
