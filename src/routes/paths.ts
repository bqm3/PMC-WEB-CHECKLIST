...
export const paths = {
  ...
  dashboard: {
    ...
    baocaochiso: {
      root: `${ROOTS.DASHBOARD}/bao-cao-chi-so`,
      new: `${ROOTS.DASHBOARD}/bao-cao-chi-so/new`,
      thongTin: `${ROOTS.DASHBOARD}/bao-cao-chi-so/thong-tin`,
      edit: (id: string) => `${ROOTS.DASHBOARD}/bao-cao-chi-so/${id}/edit`,
    },
    chukyduan:  {
    ...
    phanhe: {
      root: `${ROOTS.DASHBOARD}/phanhe`,
      admin: `${ROOTS.DASHBOARD}/phanhe/admin`,
    },
    beboi: {
      root: `${ROOTS.DASHBOARD}/beboi`,
      admin: `${ROOTS.DASHBOARD}/beboi/admin`,
      new: `${ROOTS.DASHBOARD}/beboi/new`,
